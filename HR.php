...
<button ><a href="EmpEditform.php?EID=<?php echo $EID; ?>"> Edit Account </a> </button>
		...
		<br>
		<br>
		<h3>Human Resource privilage:</h3>
		</div>
	            ...
	            <div class="row">
	            	<div class="col-sm-3">
		                <div class="service wow fadeInUp">
		                    ...
		                    <p>The Admin,Employee and HR can show 20 employees information in the contact page .</p> </br>
					...
					<div class="col-sm-3">
		                <div class="service wow fadeInDown">
		                    ...
		                    <h3>Show detailed information</h3>
		                    <p>The Admin, Employee and HR can get more information about an employee through the card.                                        </p> </br>
		                    <div class="work-bottom">
								<a class="big-link-2" href="contact.php"><i class="fa fa-link"></i></a>
		                    </div>
		                </div>
	                ...
	                <div class="col-sm-3">
		                <div class="service wow fadeInDown">
		                    ...
		                    <h3>Receive purchase order and Reply for request</h3>
		                    <p> The HR receives purchase order from employee and Replyed if his order Accept or canceled</p>
		                   <div class="work-bottom">
		                        <a class="big-link-2" href="ordersdisplay.php"><i class="fa fa-link"></i></a>
		                    </div>
		                </div>
	                </div>
	            </div>
