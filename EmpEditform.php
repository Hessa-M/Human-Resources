...
<?php
	...
	if(isset($_SESSION['error']) && !empty($_SESSION['error']))
			{
                ...
                echo ' <i class="glyphicon glyphicon-warning-sign"></i> &nbsp; '; echo $_SESSION['error']; 
                echo '</div>';
                echo ' </div>';
 }	
	...
	for($i=0; $row = $result->fetch(); $i++){
	            ...
	            echo '        		<label for="add-name">Name</label>';
				echo '				<br>';
	            echo '            	<input type="text" size="70" name="Ename" class="add-name" id="add-name" value="'.$row['Ename'].'" >';
	            echo '            </div>';
	            echo '        	<div class="form-group">';
				echo '			 <br>';
	            echo '        		<label for="add-email">Email</label>';
				echo '				<br>';
	            echo '            	<input type="text" size="70" name="Email" class="add-email" id="add-email" value="'. $row['Email'].'" >';
	            echo '            </div>';
				echo '			<br>';
	            echo '            <div class="form-group">';
	            echo '            	<label for="add-password">Password</label>';
				echo '				<br>';
	            echo '            	<input type="password" size="70" name="Password" placeholder="Enter your password" class="add-password" id="add-password">';
	            echo '            </div>';
				echo '			<br>';
				echo '			<div class="form-group">';
				echo '			<br>';
	            echo '            	<label for="add-password">Confirm password</label>';
	            echo '            	<br>';
				echo '				<input type="password" size="70" name="ConfirmPassword" placeholder="Repet your password" class="add-password" id="add-password">';
	            echo '            </div>';
				echo '			<div class="form-group">';
	            echo '            	<br>';
				echo '				<label for="add-Briefjobdescription">Brief job description</label>';
	            echo '            	<br>';
				echo '				<textarea type="text" rows="5" style="resize: none;" cols="70" name="BriefJobDescription" class="add-Briefjobdescription" id="aboutDescription">'.$row['BriefJobDescription'].'</textarea>';
				echo '            </div>';
				echo '			<button type="submit" id="buttSub" name="but-save">Save</button> '; 
				echo '			<br><br>';
				echo '			<button type="submit" id="buttSub" >Cancel </button>';
	            echo '        </form>';
	}
