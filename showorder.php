...
#btnsh:active:focus, #btnsh.active:focus {
  ...
  <ul class="breadcrumb">
    ...
    <li><a   href="ordersdisplay.php">Orders Display</a></li>
...
<?php
		             ...
		             $result = $user->runQuery("SELECT * FROM purchaseorder where OID =:OID");
		             $result->execute(array(':OID' =>$OID));
	                 ...
	                 $result2 = $user->runQuery("SELECT * FROM employee where EID=:EID");
		             $result2->execute(array(':EID' =>$EID));
	                 for($i=0; $row2 = $result2->fetch(); $i++){
		             $ename= $row2['Ename']; 
					 $Username=$row2['Username'];
					 }
					 echo'<h4>Request Number :</h4>  ';
					 echo'<h5>&nbsp;&nbsp;&nbsp;'.$OID.'</h5>';
					 echo'<br>';
					 ...
					 echo '<h5>&nbsp;&nbsp;&nbsp;'.$Username.'</h5>';			
					 echo' </br> <h4> Content of request :</h4>';			
		             echo '<h5>&nbsp;&nbsp;&nbsp;'.$content.'</h5>' ;
					 echo '</br>';
					 echo '<h4>Request Type :</h4>';
					 $result2 = $user->runQuery("SELECT * FROM resource where RID =:RID");
		             $result2->execute(array(':RID' =>$RID));
	                 for($i=0; $row2 = $result2->fetch(); $i++){
		    
					 $type= $row2['Type'];
					 $Qavaliable = $row2['Quantity'];
					 }
                	  echo '<h5>&nbsp;&nbsp;&nbsp;'.$type.'</h5>' ;
					  echo '</br>';
					  echo '<h4>Request Date:</h4> ';
					  echo '<h5>&nbsp;&nbsp;&nbsp;'.$RequestDate.'</h5>';
                      echo ' </p>';
	                  echo ' <br>';
	                  echo '<h4> Replay State : </h5>';
                      echo '<h5>&nbsp;&nbsp;&nbsp;'.$ReplyStatus.'</h5>';
                      echo '</br>';
					  echo' </br> <h4> Comment of request :</h4>';			
		              echo '<h5>&nbsp;&nbsp;&nbsp;'.$comment.'</h5>' ;
					  echo '</br></br>';
