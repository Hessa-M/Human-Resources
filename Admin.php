	            ...
	            <div class="row">
	            	<div class="col-sm-3">
		                <div class="service wow fadeInUp">
		                    ...
		                    <p>The Admin responsible for creating users account for the system such as employee account and HR account.</p>
		                    <div class="work-bottom">
		                        <a class="big-link-2" href="AddAcount.php"><i class="fa fa-link"></i></a>
		                    </div>
		                </div>
					</div>
					<div class="col-sm-3">
		                <div class="service wow fadeInDown">
		                    <div class="service-icon"><i class="glyphicon glyphicon-pencil"></i></div>
		                    <h3>Edit Account</h3>
		                    <p>The Admin can Edit any updated information for all employees such as HR or normal employee</p>
							
		                    <div class="work-bottom">
		                        <a class="big-link-2" href="Delete.php"><i class="fa fa-link"></i></a>
		                    </div>
		                </div>
	                </div>
	                <div class="col-sm-3">
		                <div class="service wow fadeInUp">
		                    <div class="service-icon"><i class="fa fa-trash-o"></i></div>
		                    <h3>Delete Account</h3>
		                    <p> The Admin, Employee and HR can search for an employee in the company by name.</p><br>
		                    <div class="work-bottom">
		                        <a class="big-link-2" href="Delete.php"><i class="fa fa-link"></i></a>
		                    </div>
		                </div>
