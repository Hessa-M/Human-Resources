...
<?php	
    ...
    $user = new USER();
          		...
          		//<!--Search -->
                   ...
                   echo'		<h4>Send message to: </h4>';
                   echo'        <div class="input_container">';
                   echo'            <input type="text" name="uname2" id="User_names" onkeyup="autocomplet()" placeholder="Enter a name">';
                   echo'            <ul id="User_names_list"></ul>';
      	           echo'        </div>';
		           echo'	&nbsp;&nbsp;&nbsp;<input type="submit" name="btnsearch" class="btn" value="search"></input>';
	               echo'   </form>';
				//--------------   
